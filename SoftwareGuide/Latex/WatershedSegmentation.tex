...
original input data, but is derived from those data through some filtering,
...
are the local maxima of $f$, and the results of the watershed segmentation are
...
threshold, which helps minimize oversegmentation of the image.  The
